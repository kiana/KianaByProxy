...
public class AmazonClientManager {
	...
	private AmazonDynamoDBClient amazonDBClient = null;
	...
	public AmazonDynamoDBClient getAmazonDBClient() {
		validateCredentials();
	...
	public Response validateCredentials() {
		...
		} else if (amazonDBClient == null) {

			synchronized (this) {

				if (amazonDBClient == null) {
	...
	private void initClients() {
		...
		amazonDBClient = new AmazonDynamoDBClient( credentials );
	}
